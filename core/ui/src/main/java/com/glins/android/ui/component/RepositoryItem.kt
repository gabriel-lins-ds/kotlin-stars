...
import com.glins.android.ui.constants.UiConstants.AVATAR_SIZE
import com.glins.android.ui.constants.UiConstants.GITHUB_URL_AVATAR_SIZE_SUFFIX
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(
                    ...
                    if (!repository.description.isNullOrBlank()) {
                        ...
                        Text(
                            text = repository.description!!, // TODO: Ver
                            style = MaterialTheme.typography.bodySmall,
                            maxLines = 2,
                            overflow = TextOverflow.Ellipsis
                        )
